...
#ifdef __cplusplus
  #ifdef pSimSSM_ST_test_valiidVTable_defined
    extern struct SimTypeVTable *pSimSSM_ST_test_valiidVTable;
  #else 
    struct SimTypeVTable *pSimSSM_ST_test_valiidVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_ST_test_valiidVTable;
#endif

static SimEnumValUtils SSM_ST_test_valiid_values[] = {
    { "valid_all", SSM_st_valid_all_test_valiid},
    { "valid_all", SSM_st_valid_all_test_valiid},
    { "Eliminate_1", SSM_st_Eliminate_1_test_valiid},
    { "Eliminate_1", SSM_st_Eliminate_1_test_valiid},
    { "Eliminate_2", SSM_st_Eliminate_2_test_valiid},
    { "Eliminate_2", SSM_st_Eliminate_2_test_valiid},
    { "Eliminate_3", SSM_st_Eliminate_3_test_valiid},
    { "Eliminate_3", SSM_st_Eliminate_3_test_valiid},
    { "Invalid", SSM_st_Invalid_test_valiid},
    { "Invalid", SSM_st_Invalid_test_valiid},
};
const int SSM_ST_test_valiid_nb_values = 10;

int SSM_ST_test_valiid_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_ST_test_valiidVTable != NULL
        && pSimSSM_ST_test_valiidVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_ST_test_valiidVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_ST_test_valiid*)pValue, SSM_ST_test_valiid_values, SSM_ST_test_valiid_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_ST_test_valiid_string(const char *str, char **endptr)
{
    static SSM_ST_test_valiid rTemp;
    return string_to_SSM_ST_test_valiid(str, (void*)&rTemp, endptr);
}

int string_to_SSM_ST_test_valiid(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_ST_test_valiidVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_ST_test_valiidVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_ST_test_valiid_values, SSM_ST_test_valiid_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_ST_test_valiid*)pValue = (SSM_ST_test_valiid)nTemp;
    }
    return nRet;
}

int is_SSM_ST_test_valiid_double_conversion_allowed()
{
    if (pSimSSM_ST_test_valiidVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_ST_test_valiidVTable);
    }
    return 1;
}

int SSM_ST_test_valiid_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_ST_test_valiidVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_ST_test_valiidVTable, nValue);
    }
    *nValue = (double)*((SSM_ST_test_valiid*)pValue);
    return 1;
}

int is_SSM_ST_test_valiid_long_conversion_allowed()
{
    if (pSimSSM_ST_test_valiidVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_ST_test_valiidVTable);
    }
    return 1;
}

int SSM_ST_test_valiid_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_ST_test_valiidVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_ST_test_valiidVTable, nValue);
    }
    *nValue = (long)*((SSM_ST_test_valiid*)pValue);
    return 1;
}

void compare_SSM_ST_test_valiid(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_ST_test_valiidVTable != NULL
        && pSimSSM_ST_test_valiidVTable->m_version >= Scv612
        && pSimSSM_ST_test_valiidVTable->m_pfnCompare != NULL) {
        if (pSimSSM_ST_test_valiidVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_ST_test_valiidVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_ST_test_valiidVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_ST_test_valiid*)pValue1), (int)(*(SSM_ST_test_valiid*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_SSM_ST_test_valiid_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_ST_test_valiid_values, SSM_ST_test_valiid_nb_values, pfnStrAppend, pStrObj);
}

int init_SSM_ST_test_valiid(void *pValue)
{
    *(SSM_ST_test_valiid*)pValue = SSM_st_valid_all_test_valiid;
    return 1;
}

int release_SSM_ST_test_valiid(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_SSM_ST_test_valiid(void *pToValue, const void *pFromValue)
{
    *((SSM_ST_test_valiid*)pToValue) = *((SSM_ST_test_valiid*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_ST_test_valiid_Utils = {
    SSM_ST_test_valiid_to_string,
    check_SSM_ST_test_valiid_string,
    string_to_SSM_ST_test_valiid,
    is_SSM_ST_test_valiid_double_conversion_allowed,
    SSM_ST_test_valiid_to_double,
    is_SSM_ST_test_valiid_long_conversion_allowed,
    SSM_ST_test_valiid_to_long,
    compare_SSM_ST_test_valiid,
    get_SSM_ST_test_valiid_signature,
    init_SSM_ST_test_valiid,
    release_SSM_ST_test_valiid,
    copy_SSM_ST_test_valiid,
    sizeof(SSM_ST_test_valiid)
};
...
#ifdef __cplusplus
  #ifdef pSimSSM_TR_test_valiidVTable_defined
    extern struct SimTypeVTable *pSimSSM_TR_test_valiidVTable;
  #else 
    struct SimTypeVTable *pSimSSM_TR_test_valiidVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_TR_test_valiidVTable;
#endif

static SimEnumValUtils SSM_TR_test_valiid_values[] = {
    { "SSM_TR_no_trans_test_valiid", SSM_TR_no_trans_test_valiid},
    { "SSM_TR_no_trans_test_valiid", SSM_TR_no_trans_test_valiid},
    { "SSM_TR_valid_all_Eliminate_1_1_valid_all_test_valiid", SSM_TR_valid_all_Eliminate_1_1_valid_all_test_valiid},
    { "SSM_TR_valid_all_Eliminate_1_1_valid_all_test_valiid", SSM_TR_valid_all_Eliminate_1_1_valid_all_test_valiid},
    { "SSM_TR_valid_all_Eliminate_2_2_valid_all_test_valiid", SSM_TR_valid_all_Eliminate_2_2_valid_all_test_valiid},
    { "SSM_TR_valid_all_Eliminate_2_2_valid_all_test_valiid", SSM_TR_valid_all_Eliminate_2_2_valid_all_test_valiid},
    { "SSM_TR_valid_all_Eliminate_3_3_valid_all_test_valiid", SSM_TR_valid_all_Eliminate_3_3_valid_all_test_valiid},
    { "SSM_TR_valid_all_Eliminate_3_3_valid_all_test_valiid", SSM_TR_valid_all_Eliminate_3_3_valid_all_test_valiid},
    { "SSM_TR_Eliminate_1_Invalid_1_Eliminate_1_test_valiid", SSM_TR_Eliminate_1_Invalid_1_Eliminate_1_test_valiid},
    { "SSM_TR_Eliminate_1_Invalid_1_Eliminate_1_test_valiid", SSM_TR_Eliminate_1_Invalid_1_Eliminate_1_test_valiid},
    { "SSM_TR_Eliminate_2_Invalid_1_Eliminate_2_test_valiid", SSM_TR_Eliminate_2_Invalid_1_Eliminate_2_test_valiid},
    { "SSM_TR_Eliminate_2_Invalid_1_Eliminate_2_test_valiid", SSM_TR_Eliminate_2_Invalid_1_Eliminate_2_test_valiid},
    { "SSM_TR_Eliminate_3_Invalid_1_Eliminate_3_test_valiid", SSM_TR_Eliminate_3_Invalid_1_Eliminate_3_test_valiid},
    { "SSM_TR_Eliminate_3_Invalid_1_Eliminate_3_test_valiid", SSM_TR_Eliminate_3_Invalid_1_Eliminate_3_test_valiid},
};
const int SSM_TR_test_valiid_nb_values = 14;

int SSM_TR_test_valiid_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_TR_test_valiidVTable != NULL
        && pSimSSM_TR_test_valiidVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_TR_test_valiidVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_TR_test_valiid*)pValue, SSM_TR_test_valiid_values, SSM_TR_test_valiid_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_TR_test_valiid_string(const char *str, char **endptr)
{
    static SSM_TR_test_valiid rTemp;
    return string_to_SSM_TR_test_valiid(str, (void*)&rTemp, endptr);
}

int string_to_SSM_TR_test_valiid(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_TR_test_valiidVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_TR_test_valiidVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_TR_test_valiid_values, SSM_TR_test_valiid_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_TR_test_valiid*)pValue = (SSM_TR_test_valiid)nTemp;
    }
    return nRet;
}

int is_SSM_TR_test_valiid_double_conversion_allowed()
{
    if (pSimSSM_TR_test_valiidVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_TR_test_valiidVTable);
    }
    return 1;
}

int SSM_TR_test_valiid_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_TR_test_valiidVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_TR_test_valiidVTable, nValue);
    }
    *nValue = (double)*((SSM_TR_test_valiid*)pValue);
    return 1;
}

int is_SSM_TR_test_valiid_long_conversion_allowed()
{
    if (pSimSSM_TR_test_valiidVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_TR_test_valiidVTable);
    }
    return 1;
}

int SSM_TR_test_valiid_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_TR_test_valiidVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_TR_test_valiidVTable, nValue);
    }
    *nValue = (long)*((SSM_TR_test_valiid*)pValue);
    return 1;
}

void compare_SSM_TR_test_valiid(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_TR_test_valiidVTable != NULL
        && pSimSSM_TR_test_valiidVTable->m_version >= Scv612
        && pSimSSM_TR_test_valiidVTable->m_pfnCompare != NULL) {
        if (pSimSSM_TR_test_valiidVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_TR_test_valiidVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_TR_test_valiidVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_TR_test_valiid*)pValue1), (int)(*(SSM_TR_test_valiid*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_SSM_TR_test_valiid_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_TR_test_valiid_values, SSM_TR_test_valiid_nb_values, pfnStrAppend, pStrObj);
}

int init_SSM_TR_test_valiid(void *pValue)
{
    *(SSM_TR_test_valiid*)pValue = SSM_TR_no_trans_test_valiid;
    return 1;
}

int release_SSM_TR_test_valiid(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_SSM_TR_test_valiid(void *pToValue, const void *pFromValue)
{
    *((SSM_TR_test_valiid*)pToValue) = *((SSM_TR_test_valiid*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_TR_test_valiid_Utils = {
    SSM_TR_test_valiid_to_string,
    check_SSM_TR_test_valiid_string,
    string_to_SSM_TR_test_valiid,
    is_SSM_TR_test_valiid_double_conversion_allowed,
    SSM_TR_test_valiid_to_double,
    is_SSM_TR_test_valiid_long_conversion_allowed,
    SSM_TR_test_valiid_to_long,
    compare_SSM_TR_test_valiid,
    get_SSM_TR_test_valiid_signature,
    init_SSM_TR_test_valiid,
    release_SSM_TR_test_valiid,
    copy_SSM_TR_test_valiid,
    sizeof(SSM_TR_test_valiid)
};
