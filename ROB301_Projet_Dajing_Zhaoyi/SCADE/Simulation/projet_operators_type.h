#ifndef PROJET_OPERATORS_TYPES_CONVERSION
#define PROJET_OPERATORS_TYPES_CONVERSION
 ...
 ** SSM_ST_test_valiid 
 ****************************************************************/
extern int SSM_ST_test_valiid_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_SSM_ST_test_valiid_string(const char *str, char **endptr);
extern int string_to_SSM_ST_test_valiid(const char *str, void *pValue, char **endptr);
extern int is_SSM_ST_test_valiid_double_conversion_allowed();
extern int SSM_ST_test_valiid_to_double(const void *pValue, double *nValue);
extern int is_SSM_ST_test_valiid_long_conversion_allowed();
extern int SSM_ST_test_valiid_to_long(const void *pValue, long *nValue);
extern void compare_SSM_ST_test_valiid(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_SSM_ST_test_valiid_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int init_SSM_ST_test_valiid(void *pValue);
extern int release_SSM_ST_test_valiid(void *pValue);
extern int copy_SSM_ST_test_valiid(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_SSM_ST_test_valiid_Utils;

/****************************************************************
 ** SSM_TR_test_valiid 
 ****************************************************************/
extern int SSM_TR_test_valiid_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_SSM_TR_test_valiid_string(const char *str, char **endptr);
extern int string_to_SSM_TR_test_valiid(const char *str, void *pValue, char **endptr);
extern int is_SSM_TR_test_valiid_double_conversion_allowed();
extern int SSM_TR_test_valiid_to_double(const void *pValue, double *nValue);
extern int is_SSM_TR_test_valiid_long_conversion_allowed();
extern int SSM_TR_test_valiid_to_long(const void *pValue, long *nValue);
extern void compare_SSM_TR_test_valiid(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_SSM_TR_test_valiid_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int init_SSM_TR_test_valiid(void *pValue);
extern int release_SSM_TR_test_valiid(void *pValue);
extern int copy_SSM_TR_test_valiid(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_SSM_TR_test_valiid_Utils;


#endif /*PROJET_OPERATORS_TYPES_CONVERSION */
