...
/* ifvalid_sensor/test_valiid: */
typedef enum kcg_tag_SSM_TR_test_valiid {
  SSM_TR_no_trans_test_valiid,
...
/* ifvalid_sensor/test_valiid: */
typedef enum kcg_tag_SSM_ST_test_valiid {
  SSM_st_valid_all_test_valiid,
  SSM_st_Eliminate_1_test_valiid,
  SSM_st_Eliminate_2_test_valiid,
  SSM_st_Eliminate_3_test_valiid,
  SSM_st_Invalid_test_valiid
} SSM_ST_test_valiid;
#endif /* _KCG_TYPES_H_ */
/* $******* SCADE Suite KCG 32-bit 6.6.1 beta (build i1) ********
** kcg_types.h
